...
<div class="content">
    <h2>Detail Dokumen (Review MR)</h2>
    ...
    <a href="<?= BASE_URL ?>?controller=Mr&action=approve&id=<?= $document['id']; ?>"
       onclick="return confirm('Setujui dan lanjut ke GM?')"
       style="color:green;font-weight:bold">
       ✔ Approve
    </a>
    |
    <a href="<?= BASE_URL ?>?controller=Mr&action=reject&id=<?= $document['id']; ?>"
    ...
    <br><br>
    <a href="<?= BASE_URL ?>?controller=Mr&action=index">← Kembali</a>
</div>
