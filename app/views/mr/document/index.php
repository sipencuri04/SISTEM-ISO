        ...
        <table class="table">
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="action">
                        <a class="view"
                           href="<?= BASE_URL ?>?controller=Mr&action=show&id=<?= $doc['id']; ?>">
                           🔍 Lihat
                        </a>

                        <a class="approve"
                           href="<?= BASE_URL ?>?controller=Mr&action=approve&id=<?= $doc['id']; ?>"
                           onclick="return confirm('Setujui dokumen ini dan lanjut ke GM?')">
                           ✅ Approve
                        </a>

                        <a class="reject"
                           href="<?= BASE_URL ?>?controller=Mr&action=reject&id=<?= $doc['id']; ?>"
