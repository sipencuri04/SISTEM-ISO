...
<div class="content">
    <div class="card">
        ...
        <div class="actions">
            <a class="approve"
               href="<?= BASE_URL_INDEX ?>?controller=Gm&action=approve&id=<?= $document['id']; ?>"
               onclick="return confirm('Sahkan dokumen ini sebagai dokumen resmi perusahaan?')">
               ✔ Sahkan (Final)
            </a>

            <a class="reject"
               href="<?= BASE_URL_INDEX ?>?controller=Gm&action=reject&id=<?= $document['id']; ?>"
               onclick="return confirm('Tolak dokumen ini?')">
               ✖ Tolak
            </a>

            <a class="back"
               href="<?= BASE_URL_INDEX ?>?controller=Gm&action=index">
               ← Kembali
            </a>
        </div>
