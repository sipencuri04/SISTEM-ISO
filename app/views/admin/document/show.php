...
<div class="content">
    <div class="card">
        ...
        <div class="actions">
            <a class="approve"
               href="<?= BASE_URL ?>?controller=Admin&action=approve&id=<?= $document['id']; ?>"
               onclick="return confirm('Setujui dokumen ini dan lanjut ke MR?')">
               ✔ Approve
            </a>

            <a class="reject"
               href="<?= BASE_URL ?>?controller=Admin&action=reject&id=<?= $document['id']; ?>"
               onclick="return confirm('Tolak dokumen ini?')">
               ✖ Reject
            </a>

            <a class="back"
               href="<?= BASE_URL ?>?controller=Admin&action=index">
               ← Kembali
            </a>
        </div>
